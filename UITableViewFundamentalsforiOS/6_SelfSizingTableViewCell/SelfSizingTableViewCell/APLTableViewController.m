...
//    APLRegion *region = self.displayList[indexPath.section];
//    APLTimeZoneWrapper *timeZoneWrapper = (APLTimeZoneWrapper *)region.timeZoneWrappers[indexPath.row];
//    CGFloat height = [self heightForString:timeZoneWrapper.extendedDetailText];
//    return height + 59 + 1;
//}
//
//- (CGFloat) heightForString:(NSString *)detailTitle
//{
//    CGRect rect = [detailTitle boundingRectWithSize:CGSizeMake(kWidth - 70, MAXFLOAT) options:NSStringDrawingUsesFontLeading|NSStringDrawingUsesLineFragmentOrigin attributes:@{NSFontAttributeName: [UIFont systemFontOfSize:20.0]} context:nil];
